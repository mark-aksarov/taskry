...
import { exportProjectCategories } from "../projectCategory.dal";
import { resetDatabase } from "@/lib/test-utils/resetDatabase";
import { it, expect, describe, beforeAll, afterEach } from "vitest";
import { users, positions, organizations } from "@/prisma/seed/test-data";

describe("exportProjectCategories", () => {
  beforeAll(async () => {
    await resetDatabase();
  ...
  it("should return all project categories as a list of valid ProjectCategoryCsvDTOs", async () => {
    ...
    const result = await exportProjectCategories();
