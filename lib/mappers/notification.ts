import { NotificationListItemDTO } from "../dto/notification";
import { NotificationListItemType } from "../types/notification";

export function mapNotificationListItemToDTO(
