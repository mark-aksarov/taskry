...
1.3. This Policy applies to personal data that the Controller may receive via the information and telecommunication network “Internet” when using the website  <Link href="https://taskry.ru" variant="primary" className="text-base inline-flex">https://taskry.ru</Link> (hereinafter referred to as the “Website”), as well as other subdomains of the taskry.ru domain zone, and applies to the processing of personal data carried out using automation tools.

1.4. This Policy is publicly available on the Website in the information and telecommunication network “Internet” and is permanently accessible at <Link href="https://taskry.ru/privacy-policy" variant="primary" className="text-base inline-flex">https://taskry.ru/privacy-policy</Link>.
