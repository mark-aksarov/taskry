...
async function main() {
  ...
  await prisma.task.createMany({
    data: [
      // --- Project 1 ---
      { id: 1, projectId: 1, title: "Backend API Setup", description: "Develop core backend API for e-commerce platform", deadline: new Date(now.getFullYear(), now.getMonth(), 5), statusId: 1, categoryId: 4, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9" },
      { id: 2, projectId: 1, title: "Homepage Wireframe", description: "Create wireframe for main pages of e-commerce website", deadline: new Date(now.getFullYear(), now.getMonth(), 7), statusId: 1, categoryId: 3, creatorId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3", assigneeId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI" },
      { id: 3, projectId: 1, title: "Payment Gateway Integration", description: "Integrate Stripe and PayPal payment systems", deadline: new Date(now.getFullYear(), now.getMonth(), 9), statusId: 1, categoryId: 6, creatorId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },
      { id: 4, projectId: 1, title: "Database Schema Design", description: "Design and optimize database schema for products and orders", deadline: new Date(now.getFullYear(), now.getMonth(), 11), statusId: 2, categoryId: 4, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },
      { id: 5, projectId: 1, title: "QA Testing", description: "Test all features of the platform to ensure reliability and performance", deadline: new Date(now.getFullYear(), now.getMonth(), 13), statusId: 2, categoryId: 5, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },

      // --- Project 2 ---
      { id: 6, projectId: 2, title: "Landing Page Wireframe", description: "Create wireframes for new landing page", deadline: new Date(now.getFullYear(), now.getMonth(), 6), statusId: 2, categoryId: 2, creatorId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3", assigneeId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9" },
      { id: 7, projectId: 2, title: "UI Mockup Review", description: "Review and finalize UI mockups for client approval", deadline: new Date(now.getFullYear(), now.getMonth(), 8), statusId: 3, categoryId: 1, creatorId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9", assigneeId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI" },
      { id: 8, projectId: 2, title: "CRM Integration Setup", description: "Integrate CRM system with existing platform", deadline: new Date(now.getFullYear(), now.getMonth(), 10), statusId: 3, categoryId: 6, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },
      { id: 9, projectId: 2, title: "Social Media Campaign", description: "Plan and launch marketing campaign for social media channels", deadline: new Date(now.getFullYear(), now.getMonth(), 12), statusId: 3, categoryId: 3, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },
      { id: 10, projectId: 2, title: "Website QA Testing", description: "Perform quality assurance and bug fixes on website", deadline: new Date(now.getFullYear(), now.getMonth(), 14), statusId: 1, categoryId: 5, creatorId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3", assigneeId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI" },

      // --- Project 3 ---
      { id: 11, projectId: 3, title: "On-Page SEO Audit", description: "Analyze website pages and optimize meta tags, headers, and content", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 1), statusId: 2, categoryId: 7, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },
      { id: 12, projectId: 3, title: "Content Strategy", description: "Plan and create SEO-focused blog posts and landing pages", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 2), statusId: 3, categoryId: 6, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI" },
      { id: 13, projectId: 3, title: "Keyword Research", description: "Identify high-value keywords for website optimization", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 3), statusId: 1, categoryId: 7, creatorId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3", assigneeId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI" },
      { id: 14, projectId: 3, title: "Backlink Outreach", description: "Develop and execute a backlink acquisition campaign", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 4), statusId: 2, categoryId: 7, creatorId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9", assigneeId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9" },
      { id: 15, projectId: 3, title: "SEO Analytics", description: "Set up tracking and analyze SEO performance metrics", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 5), statusId: 2, categoryId: 8, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },

      // --- Project 4 ---
      { id: 16, projectId: 4, title: "Sales Data Analysis", description: "Analyze monthly sales data and trends", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 6), statusId: 3, categoryId: 8, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },
      { id: 17, projectId: 4, title: "Wireframe Dashboard Layout", description: "Design wireframes for dashboard interface", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 7), statusId: 3, categoryId: 2, creatorId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },
      { id: 18, projectId: 4, title: "UI Mockups", description: "Create high-fidelity UI designs for dashboard screens", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 8), statusId: 3, categoryId: 1, creatorId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },
      { id: 19, projectId: 4, title: "Marketing Dashboard Insights", description: "Provide marketing KPIs and insights in dashboard format", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 9), statusId: 1, categoryId: 3, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI" },
      { id: 20, projectId: 4, title: "Backend Data Integration", description: "Connect dashboard to database and APIs for live data", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 10), statusId: 2, categoryId: 4, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9" },

      // --- Project 5 ---
      { id: 21, projectId: 5, title: "Backend API Integration", description: "Connect CRM system with backend services and APIs", deadline: new Date(now.getFullYear(), now.getMonth(), 22), statusId: 3, categoryId: 4, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI" },
      { id: 22, projectId: 5, title: "Frontend CRM Dashboard", description: "Design and implement CRM dashboard interface for users", deadline: new Date(now.getFullYear(), now.getMonth(), 24), statusId: 1, categoryId: 3, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },
      { id: 23, projectId: 5, title: "CRM Testing", description: "Perform QA testing on CRM workflows and integration points", deadline: new Date(now.getFullYear(), now.getMonth(), 26), statusId: 1, categoryId: 5, creatorId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3", assigneeId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9" },
      { id: 24, projectId: 5, title: "Data Migration", description: "Migrate existing customer data to new CRM system", deadline: new Date(now.getFullYear(), now.getMonth(), 28), statusId: 2, categoryId: 4, creatorId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },
      { id: 25, projectId: 5, title: "CRM QA & Bug Fixes", description: "Finalize testing and resolve any integration issues", deadline: new Date(now.getFullYear(), now.getMonth(), 30), statusId: 2, categoryId: 5, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },

      // --- Project 6 ---
      { id: 26, projectId: 6, title: "Landing Page Wireframe", description: "Create wireframes for the landing page layout", deadline: new Date(now.getFullYear(), now.getMonth(), 23), statusId: 1, categoryId: 2, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },
      { id: 27, projectId: 6, title: "Landing Page UI Design", description: "Design high-fidelity UI for landing page screens", deadline: new Date(now.getFullYear(), now.getMonth(), 25), statusId: 2, categoryId: 1, creatorId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },
      { id: 28, projectId: 6, title: "Marketing Copy", description: "Write persuasive content for landing page to boost conversions", deadline: new Date(now.getFullYear(), now.getMonth(), 27), statusId: 3, categoryId: 3, creatorId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9", assigneeId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI" },
      { id: 29, projectId: 6, title: "Content Integration", description: "Add text, images, and media into landing page", deadline: new Date(now.getFullYear(), now.getMonth(), 29), statusId: 3, categoryId: 6, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9" },
      { id: 30, projectId: 6, title: "Landing Page QA Testing", description: "Test landing page across devices and browsers for bugs", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 1), statusId: 2, categoryId: 5, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },

      // --- Project 7 ---
      { id: 31, projectId: 7, title: "Social Media Wireframe", description: "Draft content layout and posting schedule", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 2), statusId: 1, categoryId: 2, creatorId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3", assigneeId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI" },
      { id: 32, projectId: 7, title: "UI Design for Posts", description: "Design visual templates for social media posts", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 4), statusId: 1, categoryId: 1, creatorId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },
      { id: 33, projectId: 7, title: "Content Planning", description: "Create editorial calendar and post ideas", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 6), statusId: 2, categoryId: 3, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },
      { id: 34, projectId: 7, title: "Engagement Analytics", description: "Analyze past post performance and engagement metrics", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 8), statusId: 2, categoryId: 8, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },
      { id: 35, projectId: 7, title: "SEO & Marketing Integration", description: "Optimize posts and hashtags for SEO and reach", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 10), statusId: 3, categoryId: 7, creatorId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3", assigneeId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9" },

      // --- Project 8 ---
      { id: 36, projectId: 8, title: "Dataset Review", description: "Inspect all internal datasets for inconsistencies", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 3), statusId: 3, categoryId: 8, creatorId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },
      { id: 37, projectId: 8, title: "Data Validation Scripts", description: "Write scripts to validate dataset integrity and completeness", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 5), statusId: 3, categoryId: 4, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI" },
      { id: 38, projectId: 8, title: "Data Transformation", description: "Clean and standardize dataset formats for analysis", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 7), statusId: 1, categoryId: 4, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },
      { id: 39, projectId: 8, title: "QA Testing on Cleaned Data", description: "Test cleaned datasets for errors and accuracy", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 9), statusId: 1, categoryId: 5, creatorId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3", assigneeId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9" },
      { id: 40, projectId: 8, title: "Data Reporting", description: "Generate reports summarizing the cleaned data and improvements", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 11), statusId: 2, categoryId: 8, creatorId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },

      // --- Project 9 ---
      { id: 41, projectId: 9, title: "App Wireframing", description: "Create wireframes for mobile app screens", deadline: new Date(now.getFullYear(), now.getMonth(), 23), statusId: 3, categoryId: 2, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },
      { id: 42, projectId: 9, title: "App UI Design", description: "Design high-fidelity UI for mobile app", deadline: new Date(now.getFullYear(), now.getMonth(), 25), statusId: 1, categoryId: 3, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },
      { id: 43, projectId: 9, title: "API Integration", description: "Connect mobile app with backend services", deadline: new Date(now.getFullYear(), now.getMonth(), 27), statusId: 2, categoryId: 4, creatorId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },
      { id: 44, projectId: 9, title: "Data Sync & Analytics", description: "Implement data synchronization and analytics tracking", deadline: new Date(now.getFullYear(), now.getMonth(), 29), statusId: 3, categoryId: 4, creatorId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9", assigneeId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI" },
      { id: 45, projectId: 9, title: "App QA Testing", description: "Test app functionality across devices and fix bugs", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 1), statusId: 3, categoryId: 5, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9" },

      // --- Project 10 ---
      { id: 46, projectId: 10, title: "SEO Audit", description: "Conduct full SEO audit of the website", deadline: new Date(now.getFullYear(), now.getMonth(), 24), statusId: 1, categoryId: 7, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI" },
      { id: 47, projectId: 10, title: "Content Optimization", description: "Update website content for SEO improvements", deadline: new Date(now.getFullYear(), now.getMonth(), 26), statusId: 2, categoryId: 6, creatorId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },
      { id: 48, projectId: 10, title: "Keyword Research", description: "Research high-value keywords for website pages", deadline: new Date(now.getFullYear(), now.getMonth(), 28), statusId: 3, categoryId: 7, creatorId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },
      { id: 49, projectId: 10, title: "SEO Reporting", description: "Generate reports on current SEO metrics and performance", deadline: new Date(now.getFullYear(), now.getMonth(), 30), statusId: 3, categoryId: 8, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9" },
      { id: 50, projectId: 10, title: "Analytics Review", description: "Analyze SEO impact using website analytics", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 2), statusId: 2, categoryId: 8, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },

      // --- Project 11 ---
      { id: 51, projectId: 11, title: "Campaign Strategy", description: "Define goals and strategy for marketing campaign", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 3), statusId: 2, categoryId: 3, creatorId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },
      { id: 52, projectId: 11, title: "Audience Research", description: "Analyze target audience and market trends", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 5), statusId: 3, categoryId: 2, creatorId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },
      { id: 53, projectId: 11, title: "Visual Assets", description: "Design banners, images, and graphics for campaign", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 7), statusId: 3, categoryId: 1, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },
      { id: 54, projectId: 11, title: "Content Scheduling", description: "Plan posts and ad scheduling across channels", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 9), statusId: 2, categoryId: 3, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9" },
      { id: 55, projectId: 11, title: "Campaign Analytics", description: "Track campaign performance and engagement metrics", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 11), statusId: 1, categoryId: 8, creatorId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3", assigneeId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI" },

      // --- Project 12 ---
      { id: 56, projectId: 12, title: "Frontend Optimization", description: "Refactor frontend code to improve dashboard performance", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 4), statusId: 1, categoryId: 2, creatorId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },
      { id: 57, projectId: 12, title: "Feature Planning", description: "Define new dashboard features and enhancements", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 6), statusId: 2, categoryId: 3, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },
      { id: 58, projectId: 12, title: "Backend Integration", description: "Integrate new data endpoints for dashboard metrics", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 8), statusId: 3, categoryId: 4, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI" },
      { id: 59, projectId: 12, title: "QA Testing", description: "Test all dashboard features for bugs and performance issues", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 10), statusId: 1, categoryId: 5, creatorId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3", assigneeId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9" },
      { id: 60, projectId: 12, title: "Data Visualization Updates", description: "Enhance charts and graphs for better analytics insights", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 12), statusId: 2, categoryId: 8, creatorId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },

      // --- Project 13 ---
      { id: 61, projectId: 13, title: "Database Setup", description: "Design and implement database schema for inventory", deadline: new Date(now.getFullYear(), now.getMonth(), 25), statusId: 3, categoryId: 4, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },
      { id: 62, projectId: 13, title: "UI Wireframes", description: "Create wireframes for inventory management interface", deadline: new Date(now.getFullYear(), now.getMonth(), 27), statusId: 2, categoryId: 3, creatorId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },
      { id: 63, projectId: 13, title: "Backend API", description: "Develop backend endpoints to handle inventory operations", deadline: new Date(now.getFullYear(), now.getMonth(), 29), statusId: 1, categoryId: 4, creatorId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3", assigneeId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9" },
      { id: 64, projectId: 13, title: "Analytics Dashboard", description: "Integrate inventory analytics and reporting features", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 1), statusId: 2, categoryId: 8, creatorId: "VQmrwbFoX834fHEb1q1qo7CmKVV6NLF9", assigneeId: "MNCCPei6KJZiRuIkPbdDxhhJWEoxnUlp" },
      { id: 65, projectId: 13, title: "QA & Testing", description: "Test inventory system for functionality and data integrity", deadline: new Date(now.getFullYear(), now.getMonth() - 1, 3), statusId: 3, categoryId: 5, creatorId: "BKs42HvVDEZFoaJUmTqf1gTN0K8pUFjI", assigneeId: "W9OZkgMnF12FNBlys4frkj1Lj5de5Nj3" },
    ],
  });
  ...
  await prisma.subtask.createMany({
    data: [
      // --- Task 1 ---
      { name: "Set up project structure", isDone: true, taskId: 1, deadline: new Date("2025-01-10") },
      { name: "Configure server environment", isDone: true, taskId: 1, deadline: new Date("2025-01-12") },
      { name: "Implement authentication endpoints", isDone: true, taskId: 1, deadline: new Date("2025-01-15") },
      { name: "Create user management APIs", isDone: true, taskId: 1, deadline: new Date("2025-01-17") },
      { name: "Develop product CRUD endpoints", isDone: true, taskId: 1, deadline: new Date("2025-01-20") },
      { name: "Add order processing endpoints", isDone: true, taskId: 1, deadline: new Date("2025-01-22") },
      { name: "Implement error handling & logging", isDone: true, taskId: 1, deadline: new Date("2025-01-24") },
      { name: "Add rate limiting & security middleware", isDone: false, taskId: 1, deadline: new Date("2025-01-27") },
      { name: "Write API documentation", isDone: false, taskId: 1, deadline: new Date("2025-01-30") },
      { name: "Deploy API to staging server", isDone: false, taskId: 1, deadline: new Date("2025-02-02") },

      // --- Task 2 ---
      { name: "Sketch layout ideas", isDone: true, taskId: 2, deadline: new Date("2025-02-05") },
      { name: "Design homepage header", isDone: true, taskId: 2, deadline: new Date("2025-02-07") },
      { name: "Design navigation menu", isDone: true, taskId: 2, deadline: new Date("2025-02-09") },
      { name: "Wireframe hero section", isDone: true, taskId: 2, deadline: new Date("2025-02-11") },
      { name: "Wireframe product showcase section", isDone: true, taskId: 2, deadline: new Date("2025-02-13") },
      { name: "Wireframe footer section", isDone: true, taskId: 2, deadline: new Date("2025-02-15") },
      { name: "Review and refine wireframes", isDone: true, taskId: 2, deadline: new Date("2025-02-17") },

      // --- Task 3 ---
      { name: "Set up Stripe account", isDone: true, taskId: 3, deadline: new Date("2025-03-01") },
      { name: "Set up PayPal account", isDone: true, taskId: 3, deadline: new Date("2025-03-03") },
      { name: "Install payment SDKs", isDone: true, taskId: 3, deadline: new Date("2025-03-05") },
      { name: "Implement Stripe checkout flow", isDone: true, taskId: 3, deadline: new Date("2025-03-08") },
      { name: "Implement PayPal checkout flow", isDone: true, taskId: 3, deadline: new Date("2025-03-10") },
      { name: "Handle payment success & failure callbacks", isDone: true, taskId: 3, deadline: new Date("2025-03-12") },
      { name: "Secure API keys in environment variables", isDone: true, taskId: 3, deadline: new Date("2025-03-14") },
      { name: "Add subscription support", isDone: false, taskId: 3, deadline: new Date("2025-03-17") },
      { name: "Write automated payment tests", isDone: false, taskId: 3, deadline: new Date("2025-03-20") },
      { name: "Integrate payment history tracking", isDone: false, taskId: 3, deadline: new Date("2025-03-22") },
      { name: "Localize payment UI", isDone: false, taskId: 3, deadline: new Date("2025-03-24") },
      { name: "Deploy payments to staging", isDone: false, taskId: 3, deadline: new Date("2025-03-27") },

      // --- Task 4 ---
      { name: "Define entities and relationships", isDone: true, taskId: 4, deadline: new Date("2025-04-01") },
      { name: "Design products table schema", isDone: true, taskId: 4, deadline: new Date("2025-04-03") },
      { name: "Design orders table schema", isDone: true, taskId: 4, deadline: new Date("2025-04-05") },
      { name: "Design users table schema", isDone: true, taskId: 4, deadline: new Date("2025-04-07") },
      { name: "Add indexing for performance", isDone: true, taskId: 4, deadline: new Date("2025-04-09") },
      { name: "Normalize schema where necessary", isDone: true, taskId: 4, deadline: new Date("2025-04-11") },
      { name: "Add foreign key constraints", isDone: true, taskId: 4, deadline: new Date("2025-04-13") },
      { name: "Design audit logs table", isDone: false, taskId: 4, deadline: new Date("2025-04-16") },
      { name: "Document schema in ERD tool", isDone: false, taskId: 4, deadline: new Date("2025-04-18") },

      // --- Task 5 ---
      { name: "Write test plan", isDone: true, taskId: 5, deadline: new Date("2025-04-20") },
      { name: "Set up testing environment", isDone: true, taskId: 5, deadline: new Date("2025-04-22") },
      { name: "Perform unit tests", isDone: true, taskId: 5, deadline: new Date("2025-04-24") },
      { name: "Perform integration tests", isDone: true, taskId: 5, deadline: new Date("2025-04-26") },
      { name: "Perform end-to-end tests", isDone: true, taskId: 5, deadline: new Date("2025-04-28") },
      { name: "Check cross-browser compatibility", isDone: true, taskId: 5, deadline: new Date("2025-04-30") },
      { name: "Run performance tests", isDone: true, taskId: 5, deadline: new Date("2025-05-02") },
      { name: "Conduct security testing", isDone: false, taskId: 5, deadline: new Date("2025-05-05") },
      { name: "Document test results", isDone: false, taskId: 5, deadline: new Date("2025-05-07") },
      { name: "Fix critical bugs found", isDone: false, taskId: 5, deadline: new Date("2025-05-09") },
      { name: "Retest after bug fixes", isDone: false, taskId: 5, deadline: new Date("2025-05-11") },

      // --- Task 6 ---
      { name: "Brainstorm landing page structure", isDone: true, taskId: 6, deadline: new Date("2025-05-15") },
      { name: "Wireframe header & navigation", isDone: true, taskId: 6, deadline: new Date("2025-05-17") },
      { name: "Wireframe hero section", isDone: true, taskId: 6, deadline: new Date("2025-05-19") },
      { name: "Wireframe features section", isDone: true, taskId: 6, deadline: new Date("2025-05-21") },
      { name: "Wireframe testimonials section", isDone: false, taskId: 6, deadline: new Date("2025-05-23") },
      { name: "Wireframe call-to-action section", isDone: true, taskId: 6, deadline: new Date("2025-05-25") },
      { name: "Wireframe footer section", isDone: true, taskId: 6, deadline: new Date("2025-05-27") },
      { name: "Review wireframes with team", isDone: true, taskId: 6, deadline: new Date("2025-05-29") },
      { name: "Refine based on feedback", isDone: true, taskId: 6, deadline: new Date("2025-05-31") },
      { name: "Export wireframes for client", isDone: false, taskId: 6, deadline: new Date("2025-06-03") },
      { name: "Prepare presentation slides", isDone: false, taskId: 6, deadline: new Date("2025-06-05") },
      { name: "Finalize approval notes", isDone: false, taskId: 6, deadline: new Date("2025-06-07") },

      // --- Task 7 ---
      { name: "Collect all UI mockups", isDone: true, taskId: 7, deadline: new Date("2025-06-10") },
      { name: "Check consistency in colors", isDone: true, taskId: 7, deadline: new Date("2025-06-12") },
      { name: "Check typography & spacing", isDone: true, taskId: 7, deadline: new Date("2025-06-14") },
      { name: "Identify usability issues", isDone: false, taskId: 7, deadline: new Date("2025-06-16") },
      { name: "Compare mockups with wireframes", isDone: true, taskId: 7, deadline: new Date("2025-06-18") },
      { name: "Review with design team", isDone: true, taskId: 7, deadline: new Date("2025-06-20") },
      { name: "Prepare notes for client", isDone: true, taskId: 7, deadline: new Date("2025-06-22") },

      // --- Task 8 ---
      { name: "Choose CRM system & confirm credentials", isDone: true, taskId: 8, deadline: new Date("2025-06-25") },
      { name: "Install CRM integration SDK", isDone: true, taskId: 8, deadline: new Date("2025-06-27") },
      { name: "Set up API connection", isDone: true, taskId: 8, deadline: new Date("2025-06-29") },
      { name: "Sync customer data model", isDone: false, taskId: 8, deadline: new Date("2025-07-01") },
      { name: "Map CRM fields to platform database", isDone: true, taskId: 8, deadline: new Date("2025-07-03") },
      { name: "Implement lead capture forms", isDone: true, taskId: 8, deadline: new Date("2025-07-05") },
      { name: "Test data synchronization", isDone: true, taskId: 8, deadline: new Date("2025-07-07") },
      { name: "Handle error states", isDone: false, taskId: 8, deadline: new Date("2025-07-09") },
      { name: "Add logging & monitoring", isDone: false, taskId: 8, deadline: new Date("2025-07-11") },
      { name: "Secure API keys in env variables", isDone: true, taskId: 8, deadline: new Date("2025-07-13") },
      { name: "Document CRM integration flow", isDone: false, taskId: 8, deadline: new Date("2025-07-15") },
      { name: "Deploy to staging environment", isDone: false, taskId: 8, deadline: new Date("2025-07-17") },
      { name: "QA test integration", isDone: false, taskId: 8, deadline: new Date("2025-07-19") },
      { name: "Prepare client handoff", isDone: false, taskId: 8, deadline: new Date("2025-07-21") },

      // --- Task 9 ---
      { name: "Define campaign goals", isDone: true, taskId: 9, deadline: new Date("2025-07-23") },
      { name: "Select social media platforms", isDone: true, taskId: 9, deadline: new Date("2025-07-25") },
      { name: "Prepare content calendar", isDone: false, taskId: 9, deadline: new Date("2025-07-27") },
      { name: "Design campaign visuals", isDone: true, taskId: 9, deadline: new Date("2025-07-29") },
      { name: "Write ad copy & captions", isDone: true, taskId: 9, deadline: new Date("2025-07-31") },
      { name: "Schedule posts in tool", isDone: true, taskId: 9, deadline: new Date("2025-08-02") },
      { name: "Set campaign budget & targeting", isDone: true, taskId: 9, deadline: new Date("2025-08-04") },
      { name: "Launch campaign", isDone: false, taskId: 9, deadline: new Date("2025-08-06") },
      { name: "Monitor engagement metrics", isDone: false, taskId: 9, deadline: new Date("2025-08-08") },

      // --- Task 10 ---
      { name: "Set up QA environment", isDone: true, taskId: 10, deadline: new Date("2025-08-10") },
      { name: "Perform functional tests", isDone: true, taskId: 10, deadline: new Date("2025-08-12") },
      { name: "Perform integration tests", isDone: true, taskId: 10, deadline: new Date("2025-08-14") },
      { name: "Perform cross-browser tests", isDone: true, taskId: 10, deadline: new Date("2025-08-16") },
      { name: "Run performance benchmarks", isDone: true, taskId: 10, deadline: new Date("2025-08-18") },
      { name: "Log bugs in issue tracker", isDone: false, taskId: 10, deadline: new Date("2025-08-20") },
      { name: "Perform regression testing", isDone: true, taskId: 10, deadline: new Date("2025-08-22") },
      { name: "Verify bug fixes", isDone: false, taskId: 10, deadline: new Date("2025-08-24") },
      { name: "Generate QA report", isDone: true, taskId: 10, deadline: new Date("2025-08-26") },

      // --- Task 11 ---
      { name: "Crawl website pages", isDone: true, taskId: 11, deadline: new Date("2025-08-28") },
      { name: "Check page titles & meta descriptions", isDone: true, taskId: 11, deadline: new Date("2025-08-30") },
      { name: "Analyze H1–H6 header structure", isDone: true, taskId: 11, deadline: new Date("2025-09-01") },
      { name: "Review keyword placement in content", isDone: true, taskId: 11, deadline: new Date("2025-09-03") },
      { name: "Identify duplicate or missing tags", isDone: false, taskId: 11, deadline: new Date("2025-09-05") },
      { name: "Check internal linking strategy", isDone: true, taskId: 11, deadline: new Date("2025-09-07") },
      { name: "Evaluate image alt attributes", isDone: true, taskId: 11, deadline: new Date("2025-09-09") },
      { name: "Test page load speed", isDone: true, taskId: 11, deadline: new Date("2025-09-11") },
      { name: "Check mobile responsiveness", isDone: true, taskId: 11, deadline: new Date("2025-09-13") },
      { name: "Audit URL structure", isDone: false, taskId: 11, deadline: new Date("2025-09-15") },
      { name: "Generate SEO audit report", isDone: false, taskId: 11, deadline: new Date("2025-09-17") },
      { name: "Present findings to client", isDone: false, taskId: 11, deadline: new Date("2025-09-19") },

      // --- Task 12 ---
      { name: "Define target audience personas", isDone: true, taskId: 12, deadline: new Date("2025-09-21") },
      { name: "Research trending SEO topics", isDone: true, taskId: 12, deadline: new Date("2025-09-23") },
      { name: "Plan content calendar", isDone: true, taskId: 12, deadline: new Date("2025-09-25") },
      { name: "Assign blog post topics to writers", isDone: false, taskId: 12, deadline: new Date("2025-09-27") },
      { name: "Draft first blog outline", isDone: true, taskId: 12, deadline: new Date("2025-09-29") },
      { name: "Draft landing page copy", isDone: true, taskId: 12, deadline: new Date("2025-10-01") },
      { name: "Review drafts with editor", isDone: true, taskId: 12, deadline: new Date("2025-10-03") },

      // --- Task 13 ---
      { name: "List seed keywords", isDone: true, taskId: 13, deadline: new Date("2025-10-05") },
      { name: "Use keyword research tools (SEMRush/Ahrefs)", isDone: true, taskId: 13, deadline: new Date("2025-10-07") },
      { name: "Analyze search volume & difficulty", isDone: true, taskId: 13, deadline: new Date("2025-10-09") },
      { name: "Filter out irrelevant keywords", isDone: false, taskId: 13, deadline: new Date("2025-10-11") },
      { name: "Identify long-tail opportunities", isDone: true, taskId: 13, deadline: new Date("2025-10-13") },
      { name: "Map keywords to website pages", isDone: true, taskId: 13, deadline: new Date("2025-10-15") },
      { name: "Group keywords by intent", isDone: true, taskId: 13, deadline: new Date("2025-10-17") },
      { name: "Check competitor keywords", isDone: false, taskId: 13, deadline: new Date("2025-10-19") },
      { name: "Export keyword list to spreadsheet", isDone: false, taskId: 13, deadline: new Date("2025-10-21") },
      { name: "Validate keywords with client", isDone: false, taskId: 13, deadline: new Date("2025-10-23") },
      { name: "Finalize keyword strategy", isDone: true, taskId: 13, deadline: new Date("2025-10-25") },
      { name: "Prepare documentation", isDone: false, taskId: 13, deadline: new Date("2025-10-27") },
      { name: "Deliver final keyword set", isDone: false, taskId: 13, deadline: new Date("2025-10-29") },
      { name: "Add keywords to SEO tool", isDone: false, taskId: 13, deadline: new Date("2025-10-31") },

      // --- Task 14 ---
      { name: "Identify backlink opportunities", isDone: true, taskId: 14, deadline: new Date("2025-11-02") },
      { name: "Collect contact information", isDone: true, taskId: 14, deadline: new Date("2025-11-04") },
      { name: "Create outreach email templates", isDone: false, taskId: 14, deadline: new Date("2025-11-06") },
      { name: "Segment prospects by priority", isDone: true, taskId: 14, deadline: new Date("2025-11-08") },
      { name: "Send initial outreach emails", isDone: true, taskId: 14, deadline: new Date("2025-11-10") },
      { name: "Follow up with non-responders", isDone: true, taskId: 14, deadline: new Date("2025-11-12") },
      { name: "Track outreach responses", isDone: true, taskId: 14, deadline: new Date("2025-11-14") },
      { name: "Negotiate guest posting opportunities", isDone: false, taskId: 14, deadline: new Date("2025-11-16") },
      { name: "Record acquired backlinks", isDone: false, taskId: 14, deadline: new Date("2025-11-18") },

      // --- Task 15 ---
      { name: "Set up Google Analytics", isDone: true, taskId: 15, deadline: new Date("2025-11-20") },
      { name: "Set up Google Search Console", isDone: true, taskId: 15, deadline: new Date("2025-11-22") },
      { name: "Connect analytics with website", isDone: true, taskId: 15, deadline: new Date("2025-11-24") },
      { name: "Track organic traffic growth", isDone: true, taskId: 15, deadline: new Date("2025-11-26") },
      { name: "Monitor keyword rankings", isDone: true, taskId: 15, deadline: new Date("2025-11-28") },
      { name: "Analyze bounce rate", isDone: false, taskId: 15, deadline: new Date("2025-11-30") },
      { name: "Create SEO performance dashboard", isDone: true, taskId: 15, deadline: new Date("2025-12-02") },
      { name: "Generate weekly reports", isDone: false, taskId: 15, deadline: new Date("2025-12-04") },
      { name: "Present insights to stakeholders", isDone: true, taskId: 15, deadline: new Date("2025-12-06") },

      // --- Task 16 ---
      { name: "Collect monthly sales data from CRM", isDone: true, taskId: 16, deadline: new Date("2025-08-01") },
      { name: "Clean and preprocess sales dataset", isDone: true, taskId: 16, deadline: new Date("2025-08-03") },
      { name: "Identify monthly revenue trends", isDone: true, taskId: 16, deadline: new Date("2025-08-05") },
      { name: "Visualize data with charts and graphs", isDone: true, taskId: 16, deadline: new Date("2025-08-07") },
      { name: "Highlight top-performing products", isDone: false, taskId: 16, deadline: new Date("2025-08-09") },
      { name: "Analyze seasonal sales fluctuations", isDone: true, taskId: 16, deadline: new Date("2025-08-11") },
      { name: "Generate insights report for stakeholders", isDone: true, taskId: 16, deadline: new Date("2025-08-13") },
      { name: "Compare current vs previous quarter", isDone: true, taskId: 16, deadline: new Date("2025-08-15") },
      { name: "Prepare presentation slides", isDone: true, taskId: 16, deadline: new Date("2025-08-17") },
      { name: "Suggest sales strategy improvements", isDone: false, taskId: 16, deadline: new Date("2025-08-19") },
      { name: "Identify underperforming regions", isDone: false, taskId: 16, deadline: new Date("2025-08-21") },
      { name: "Forecast next quarter sales", isDone: false, taskId: 16, deadline: new Date("2025-08-23") },

      // --- Task 17 ---
      { name: "Sketch dashboard header layout", isDone: true, taskId: 17, deadline: new Date("2025-08-25") },
      { name: "Define navigation menu structure", isDone: true, taskId: 17, deadline: new Date("2025-08-27") },
      { name: "Add placeholders for KPI widgets", isDone: true, taskId: 17, deadline: new Date("2025-08-29") },
      { name: "Include filter and search components", isDone: false, taskId: 17, deadline: new Date("2025-08-31") },
      { name: "Design responsive grid layout", isDone: true, taskId: 17, deadline: new Date("2025-09-02") },
      { name: "Validate wireframes with team feedback", isDone: true, taskId: 17, deadline: new Date("2025-09-04") },
      { name: "Finalize dashboard wireframes", isDone: true, taskId: 17, deadline: new Date("2025-09-06") },

      // --- Task 18 ---
      { name: "Design dashboard login screen", isDone: true, taskId: 18, deadline: new Date("2025-09-08") },
      { name: "Create home dashboard mockup", isDone: true, taskId: 18, deadline: new Date("2025-09-10") },
      { name: "Style KPI widget components", isDone: true, taskId: 18, deadline: new Date("2025-09-12") },
      { name: "Design data visualization charts", isDone: false, taskId: 18, deadline: new Date("2025-09-14") },
      { name: "Apply brand colors and typography", isDone: true, taskId: 18, deadline: new Date("2025-09-16") },
      { name: "Export mockups for developer handoff", isDone: true, taskId: 18, deadline: new Date("2025-09-18") },
      { name: "Review mockups with stakeholders", isDone: true, taskId: 18, deadline: new Date("2025-09-20") },
      { name: "Adjust based on user feedback", isDone: false, taskId: 18, deadline: new Date("2025-09-22") },
      { name: "Ensure accessibility compliance", isDone: false, taskId: 18, deadline: new Date("2025-09-24") },
      { name: "Prepare final design package", isDone: false, taskId: 18, deadline: new Date("2025-09-26") },
      { name: "Design notification popups", isDone: true, taskId: 18, deadline: new Date("2025-09-28") },
      { name: "Refine mobile UI mockups", isDone: false, taskId: 18, deadline: new Date("2025-09-30") },
      { name: "Optimize layout for tablets", isDone: false, taskId: 18, deadline: new Date("2025-10-02") },
      { name: "Document design guidelines", isDone: false, taskId: 18, deadline: new Date("2025-10-04") },

      // --- Task 19 ---
      { name: "Define key marketing KPIs", isDone: true, taskId: 19, deadline: new Date("2025-10-06") },
      { name: "Integrate traffic analytics", isDone: true, taskId: 19, deadline: new Date("2025-10-08") },
      { name: "Add campaign performance metrics", isDone: false, taskId: 19, deadline: new Date("2025-10-10") },
      { name: "Track social media engagement", isDone: true, taskId: 19, deadline: new Date("2025-10-12") },
      { name: "Include conversion rate analysis", isDone: true, taskId: 19, deadline: new Date("2025-10-14") },
      { name: "Summarize ad spend efficiency", isDone: true, taskId: 19, deadline: new Date("2025-10-16") },
      { name: "Prepare dashboard for presentation", isDone: true, taskId: 19, deadline: new Date("2025-10-18") },
      { name: "Set up automatic data refresh", isDone: false, taskId: 19, deadline: new Date("2025-10-20") },
      { name: "Highlight best-performing campaigns", isDone: false, taskId: 19, deadline: new Date("2025-10-22") },

      // --- Task 20 ---
      { name: "Set up database connection", isDone: true, taskId: 20, deadline: new Date("2025-10-24") },
      { name: "Implement API endpoints", isDone: true, taskId: 20, deadline: new Date("2025-10-26") },
      { name: "Integrate real-time data fetch", isDone: true, taskId: 20, deadline: new Date("2025-10-28") },
      { name: "Handle authentication for API", isDone: true, taskId: 20, deadline: new Date("2025-10-30") },
      { name: "Test data synchronization", isDone: true, taskId: 20, deadline: new Date("2025-11-01") },
      { name: "Optimize query performance", isDone: false, taskId: 20, deadline: new Date("2025-11-03") },
      { name: "Set up error logging and monitoring", isDone: true, taskId: 20, deadline: new Date("2025-11-05") },
      { name: "Secure sensitive API routes", isDone: false, taskId: 20, deadline: new Date("2025-11-07") },
      { name: "Deploy backend integration", isDone: true, taskId: 20, deadline: new Date("2025-11-09") },

      // --- Task 21 ---
      { name: "Set up API authentication middleware", isDone: true, taskId: 21, deadline: new Date("2025-11-11") },
      { name: "Configure database connection pool", isDone: true, taskId: 21, deadline: new Date("2025-11-13") },
      { name: "Implement customer data API endpoint", isDone: true, taskId: 21, deadline: new Date("2025-11-15") },
      { name: "Integrate CRM with payment service API", isDone: true, taskId: 21, deadline: new Date("2025-11-17") },
      { name: "Write unit tests for API routes", isDone: false, taskId: 21, deadline: new Date("2025-11-19") },
      { name: "Add request validation and error handling", isDone: true, taskId: 21, deadline: new Date("2025-11-21") },
      { name: "Optimize API response performance", isDone: true, taskId: 21, deadline: new Date("2025-11-23") },
      { name: "Log API usage for monitoring", isDone: true, taskId: 21, deadline: new Date("2025-11-25") },
      { name: "Implement rate limiting", isDone: true, taskId: 21, deadline: new Date("2025-11-27") },
      { name: "Deploy API integration to staging", isDone: false, taskId: 21, deadline: new Date("2025-11-29") },
      { name: "Fix authentication edge cases", isDone: false, taskId: 21, deadline: new Date("2025-12-01") },
      { name: "Document API endpoints", isDone: false, taskId: 21, deadline: new Date("2025-12-03") },

      // --- Task 22 ---
      { name: "Design dashboard layout structure", isDone: true, taskId: 22, deadline: new Date("2025-12-05") },
      { name: "Implement navigation sidebar", isDone: true, taskId: 22, deadline: new Date("2025-12-07") },
      { name: "Add customer list table component", isDone: true, taskId: 22, deadline: new Date("2025-12-09") },
      { name: "Integrate live data from backend APIs", isDone: false, taskId: 22, deadline: new Date("2025-12-11") },
      { name: "Build customer profile details view", isDone: true, taskId: 22, deadline: new Date("2025-12-13") },
      { name: "Implement dashboard filters and search", isDone: true, taskId: 22, deadline: new Date("2025-12-15") },
      { name: "Ensure mobile responsive design", isDone: true, taskId: 22, deadline: new Date("2025-12-17") },

      // --- Task 23 ---
      { name: "Write test cases for CRM workflows", isDone: true, taskId: 23, deadline: new Date("2025-12-19") },
      { name: "Perform functional tests on forms", isDone: true, taskId: 23, deadline: new Date("2025-12-21") },
      { name: "Validate API responses in CRM", isDone: true, taskId: 23, deadline: new Date("2025-12-23") },
      { name: "Run regression tests on critical flows", isDone: false, taskId: 23, deadline: new Date("2025-12-25") },
      { name: "Check data integrity after operations", isDone: true, taskId: 23, deadline: new Date("2025-12-27") },
      { name: "Perform cross-browser testing", isDone: true, taskId: 23, deadline: new Date("2025-12-29") },
      { name: "Verify user role permissions", isDone: true, taskId: 23, deadline: new Date("2025-12-31") },
      { name: "Test error handling and edge cases", isDone: false, taskId: 23, deadline: new Date("2026-01-02") },
      { name: "Conduct performance and load testing", isDone: false, taskId: 23, deadline: new Date("2026-01-04") },
      { name: "Check CRM workflow automation", isDone: false, taskId: 23, deadline: new Date("2026-01-06") },
      { name: "Log and report found bugs", isDone: true, taskId: 23, deadline: new Date("2026-01-08") },
      { name: "Retest after bug fixes", isDone: false, taskId: 23, deadline: new Date("2026-01-10") },
      { name: "Validate email notifications", isDone: false, taskId: 23, deadline: new Date("2026-01-12") },
      { name: "Confirm QA test coverage completeness", isDone: false, taskId: 23, deadline: new Date("2026-01-14") },

      // --- Task 24 ---
      { name: "Export customer data from legacy CRM", isDone: true, taskId: 24, deadline: new Date("2025-10-10") },
      { name: "Clean and normalize data fields", isDone: true, taskId: 24, deadline: new Date("2025-10-11") },
      { name: "Write migration scripts", isDone: false, taskId: 24, deadline: new Date("2025-10-13") },
      { name: "Import data into new CRM database", isDone: true, taskId: 24, deadline: new Date("2025-10-14") },
      { name: "Verify migrated data accuracy", isDone: true, taskId: 24, deadline: new Date("2025-10-15") },
      { name: "Check for duplicate or missing records", isDone: true, taskId: 24, deadline: new Date("2025-10-16") },
      { name: "Validate data with stakeholders", isDone: true, taskId: 24, deadline: new Date("2025-10-17") },
      { name: "Test rollback in case of failure", isDone: false, taskId: 24, deadline: new Date("2025-10-18") },
      { name: "Finalize migration logs", isDone: false, taskId: 24, deadline: new Date("2025-10-19") },

      // --- Task 25 ---
      { name: "Review open bug tickets", isDone: true, taskId: 25, deadline: new Date("2025-10-12") },
      { name: "Reproduce reported issues", isDone: true, taskId: 25, deadline: new Date("2025-10-13") },
      { name: "Fix UI layout inconsistencies", isDone: true, taskId: 25, deadline: new Date("2025-10-14") },
      { name: "Patch API integration errors", isDone: true, taskId: 25, deadline: new Date("2025-10-15") },
      { name: "Retest fixed CRM workflows", isDone: true, taskId: 25, deadline: new Date("2025-10-16") },
      { name: "Check regression in other modules", isDone: false, taskId: 25, deadline: new Date("2025-10-17") },
      { name: "Validate bug fixes in staging", isDone: true, taskId: 25, deadline: new Date("2025-10-18") },
      { name: "Confirm fixes with QA team", isDone: false, taskId: 25, deadline: new Date("2025-10-19") },
      { name: "Close resolved bug reports", isDone: true, taskId: 25, deadline: new Date("2025-10-20") },

      // --- Task 26 ---
      { name: "Sketch initial layout ideas", isDone: true, taskId: 26, deadline: new Date("2025-10-15") },
      { name: "Wireframe header section", isDone: true, taskId: 26, deadline: new Date("2025-10-16") },
      { name: "Wireframe hero section", isDone: true, taskId: 26, deadline: new Date("2025-10-17") },
      { name: "Wireframe features section", isDone: true, taskId: 26, deadline: new Date("2025-10-18") },
      { name: "Wireframe testimonials section", isDone: false, taskId: 26, deadline: new Date("2025-10-19") },
      { name: "Wireframe pricing section", isDone: true, taskId: 26, deadline: new Date("2025-10-20") },
      { name: "Wireframe footer section", isDone: true, taskId: 26, deadline: new Date("2025-10-21") },
      { name: "Prepare mobile wireframes", isDone: true, taskId: 26, deadline: new Date("2025-10-22") },
      { name: "Prepare tablet wireframes", isDone: true, taskId: 26, deadline: new Date("2025-10-23") },
      { name: "Prepare desktop wireframes", isDone: false, taskId: 26, deadline: new Date("2025-10-24") },
      { name: "Review wireframes with team", isDone: false, taskId: 26, deadline: new Date("2025-10-25") },
      { name: "Finalize landing page wireframe", isDone: false, taskId: 26, deadline: new Date("2025-10-26") },

      // --- Task 27 ---
      { name: "Set up design system styles", isDone: true, taskId: 27, deadline: new Date("2025-10-20") },
      { name: "Design landing page header", isDone: true, taskId: 27, deadline: new Date("2025-10-21") },
      { name: "Design hero section with visuals", isDone: true, taskId: 27, deadline: new Date("2025-10-22") },
      { name: "Design features grid", isDone: false, taskId: 27, deadline: new Date("2025-10-23") },
      { name: "Design pricing tables", isDone: true, taskId: 27, deadline: new Date("2025-10-24") },
      { name: "Design testimonials section", isDone: true, taskId: 27, deadline: new Date("2025-10-25") },
      { name: "Design footer section", isDone: true, taskId: 27, deadline: new Date("2025-10-26") },

      // --- Task 28 ---
      { name: "Research competitor landing pages", isDone: true, taskId: 28, deadline: new Date("2025-10-22") },
      { name: "Define brand tone and messaging", isDone: true, taskId: 28, deadline: new Date("2025-10-23") },
      { name: "Write headline options", isDone: true, taskId: 28, deadline: new Date("2025-10-24") },
      { name: "Draft hero section copy", isDone: false, taskId: 28, deadline: new Date("2025-10-25") },
      { name: "Write features section copy", isDone: true, taskId: 28, deadline: new Date("2025-10-26") },
      { name: "Write benefits section copy", isDone: true, taskId: 28, deadline: new Date("2025-10-27") },
      { name: "Write call-to-action buttons", isDone: true, taskId: 28, deadline: new Date("2025-10-28") },
      { name: "Draft pricing section copy", isDone: false, taskId: 28, deadline: new Date("2025-10-29") },
      { name: "Write FAQ section copy", isDone: false, taskId: 28, deadline: new Date("2025-10-30") },
      { name: "Draft testimonials section text", isDone: false, taskId: 28, deadline: new Date("2025-10-31") },
      { name: "Proofread all copy", isDone: true, taskId: 28, deadline: new Date("2025-11-01") },
      { name: "Localize text for other languages", isDone: false, taskId: 28, deadline: new Date("2025-11-02") },
      { name: "Optimize copy for SEO keywords", isDone: false, taskId: 28, deadline: new Date("2025-11-03") },
      { name: "Finalize marketing copy", isDone: false, taskId: 28, deadline: new Date("2025-11-04") },

      // --- Task 29 ---
      { name: "Insert marketing copy into layout", isDone: true, taskId: 29, deadline: new Date("2025-10-25") },
      { name: "Add header images", isDone: true, taskId: 29, deadline: new Date("2025-10-26") },
      { name: "Add hero section media", isDone: false, taskId: 29, deadline: new Date("2025-10-27") },
      { name: "Integrate features icons", isDone: true, taskId: 29, deadline: new Date("2025-10-28") },
      { name: "Add pricing tables content", isDone: true, taskId: 29, deadline: new Date("2025-10-29") },
      { name: "Insert testimonials content", isDone: true, taskId: 29, deadline: new Date("2025-10-30") },
      { name: "Add footer links & info", isDone: true, taskId: 29, deadline: new Date("2025-10-31") },
      { name: "Embed videos in hero or features", isDone: false, taskId: 29, deadline: new Date("2025-11-01") },
      { name: "Optimize image sizes", isDone: false, taskId: 29, deadline: new Date("2025-11-02") },

      // --- Task 30 ---
      { name: "Test responsive design on mobile", isDone: true, taskId: 30, deadline: new Date("2025-10-28") },
      { name: "Test responsive design on tablet", isDone: true, taskId: 30, deadline: new Date("2025-10-29") },
      { name: "Test responsive design on desktop", isDone: true, taskId: 30, deadline: new Date("2025-10-30") },
      { name: "Run cross-browser tests (Chrome, Safari, Firefox)", isDone: true, taskId: 30, deadline: new Date("2025-10-31") },
      { name: "Check page load performance", isDone: true, taskId: 30, deadline: new Date("2025-11-01") },
      { name: "Conduct accessibility testing", isDone: false, taskId: 30, deadline: new Date("2025-11-02") },
      { name: "Verify forms & input fields", isDone: true, taskId: 30, deadline: new Date("2025-11-03") },
      { name: "Check broken links and 404s", isDone: false, taskId: 30, deadline: new Date("2025-11-04") },
      { name: "Log and report all found issues", isDone: true, taskId: 30, deadline: new Date("2025-11-05") },

      // --- Task 31 ---
      { name: "Draft wireframe for post layout", isDone: true, taskId: 31, deadline: new Date("2025-10-29") },
      { name: "Sketch profile page layout", isDone: true, taskId: 31, deadline: new Date("2025-10-30") },
      { name: "Wireframe story format", isDone: true, taskId: 31, deadline: new Date("2025-10-31") },
      { name: "Plan posting schedule layout", isDone: false, taskId: 31, deadline: new Date("2025-11-01") },
      { name: "Wireframe engagement section", isDone: true, taskId: 31, deadline: new Date("2025-11-02") },
      { name: "Design comment/reaction layout", isDone: true, taskId: 31, deadline: new Date("2025-11-03") },
      { name: "Wireframe ad placement spots", isDone: true, taskId: 31, deadline: new Date("2025-11-04") },
      { name: "Add mobile-friendly wireframe", isDone: false, taskId: 31, deadline: new Date("2025-11-05") },
      { name: "Finalize wireframe presentation", isDone: false, taskId: 31, deadline: new Date("2025-11-06") },

      // --- Task 32 ---
      { name: "Design Instagram post template", isDone: true, taskId: 32, deadline: new Date("2025-10-20") },
      { name: "Design Facebook post template", isDone: true, taskId: 32, deadline: new Date("2025-10-21") },
      { name: "Design Twitter/X post visuals", isDone: true, taskId: 32, deadline: new Date("2025-10-22") },
      { name: "Design story backgrounds", isDone: false, taskId: 32, deadline: new Date("2025-10-23") },
      { name: "Design carousel post layout", isDone: true, taskId: 32, deadline: new Date("2025-10-24") },
      { name: "Design call-to-action banners", isDone: true, taskId: 32, deadline: new Date("2025-10-25") },
      { name: "Prepare design system for posts", isDone: true, taskId: 32, deadline: new Date("2025-10-26") },

      // --- Task 33 ---
      { name: "Research trending topics", isDone: true, taskId: 33, deadline: new Date("2025-10-24") },
      { name: "Brainstorm post ideas", isDone: false, taskId: 33, deadline: new Date("2025-10-25") },
      { name: "Create weekly content slots", isDone: true, taskId: 33, deadline: new Date("2025-10-26") },
      { name: "Define posting frequency", isDone: true, taskId: 33, deadline: new Date("2025-10-27") },
      { name: "Align posts with campaigns", isDone: true, taskId: 33, deadline: new Date("2025-10-28") },
      { name: "Tag posts with categories", isDone: false, taskId: 33, deadline: new Date("2025-10-29") },
      { name: "Prepare drafts in content calendar", isDone: false, taskId: 33, deadline: new Date("2025-10-30") },
      { name: "Review content plan with team", isDone: true, taskId: 33, deadline: new Date("2025-10-31") },
      { name: "Schedule first batch of posts", isDone: false, taskId: 33, deadline: new Date("2025-11-01") },
      { name: "Export editorial calendar", isDone: false, taskId: 33, deadline: new Date("2025-11-02") },

      // --- Task 34 ---
      { name: "Collect past post engagement data", isDone: true, taskId: 34, deadline: new Date("2025-10-27") },
      { name: "Analyze reach and impressions", isDone: true, taskId: 34, deadline: new Date("2025-10-28") },
      { name: "Analyze click-through rates", isDone: false, taskId: 34, deadline: new Date("2025-10-29") },
      { name: "Review engagement by platform", isDone: true, taskId: 34, deadline: new Date("2025-10-30") },
      { name: "Compare hashtags performance", isDone: true, taskId: 34, deadline: new Date("2025-10-31") },
      { name: "Identify top-performing content", isDone: false, taskId: 34, deadline: new Date("2025-11-01") },
      { name: "Generate insights dashboard", isDone: false, taskId: 34, deadline: new Date("2025-11-02") },

      // --- Task 35 ---
      { name: "Research trending hashtags", isDone: true, taskId: 35, deadline: new Date("2025-10-29") },
      { name: "Optimize post descriptions", isDone: true, taskId: 35, deadline: new Date("2025-10-30") },
      { name: "Add SEO keywords to captions", isDone: true, taskId: 35, deadline: new Date("2025-10-31") },
      { name: "Test hashtag groups", isDone: true, taskId: 35, deadline: new Date("2025-11-01") },
      { name: "Optimize links for engagement", isDone: false, taskId: 35, deadline: new Date("2025-11-02") },
      { name: "Review SEO analytics tools", isDone: true, taskId: 35, deadline: new Date("2025-11-03") },
      { name: "A/B test marketing posts", isDone: false, taskId: 35, deadline: new Date("2025-11-04") },
      { name: "Finalize SEO integration", isDone: true, taskId: 35, deadline: new Date("2025-11-05") },

      // --- Task 36 ---
      { name: "Check dataset completeness", isDone: true, taskId: 36, deadline: new Date("2025-10-30") },
      { name: "Identify missing values", isDone: true, taskId: 36, deadline: new Date("2025-10-31") },
      { name: "Detect duplicate records", isDone: true, taskId: 36, deadline: new Date("2025-11-01") },
      { name: "Verify data types", isDone: false, taskId: 36, deadline: new Date("2025-11-02") },
      { name: "Review categorical consistency", isDone: true, taskId: 36, deadline: new Date("2025-11-03") },
      { name: "Spot outliers in datasets", isDone: true, taskId: 36, deadline: new Date("2025-11-04") },
      { name: "Cross-check datasets with sources", isDone: true, taskId: 36, deadline: new Date("2025-11-05") },
      { name: "Document inconsistencies", isDone: false, taskId: 36, deadline: new Date("2025-11-06") },
      { name: "Finalize dataset review report", isDone: false, taskId: 36, deadline: new Date("2025-11-07") },

      // --- Task 37 ---
      { name: "Write script for null checks", isDone: true, taskId: 37, deadline: new Date("2025-11-01") },
      { name: "Write script for duplicate checks", isDone: true, taskId: 37, deadline: new Date("2025-11-02") },
      { name: "Write script for type validation", isDone: true, taskId: 37, deadline: new Date("2025-11-03") },
      { name: "Add script for range validation", isDone: false, taskId: 37, deadline: new Date("2025-11-04") },
      { name: "Validate referential integrity", isDone: true, taskId: 37, deadline: new Date("2025-11-05") },
      { name: "Automate validation tasks", isDone: true, taskId: 37, deadline: new Date("2025-11-06") },
      { name: "Run scripts on sample dataset", isDone: true, taskId: 37, deadline: new Date("2025-11-07") },

      // --- Task 38 ---
      { name: "Standardize column naming", isDone: true, taskId: 38, deadline: new Date("2025-11-02") },
      { name: "Normalize text fields", isDone: false, taskId: 38, deadline: new Date("2025-11-03") },
      { name: "Convert date formats", isDone: true, taskId: 38, deadline: new Date("2025-11-04") },
      { name: "Unify numeric precision", isDone: true, taskId: 38, deadline: new Date("2025-11-05") },
      { name: "Handle missing values", isDone: true, taskId: 38, deadline: new Date("2025-11-06") },
      { name: "Map legacy codes to new format", isDone: false, taskId: 38, deadline: new Date("2025-11-07") },
      { name: "Transform categorical data", isDone: false, taskId: 38, deadline: new Date("2025-11-08") },
      { name: "Run transformation pipeline", isDone: true, taskId: 38, deadline: new Date("2025-11-09") },
      { name: "Check transformed dataset size", isDone: false, taskId: 38, deadline: new Date("2025-11-10") },
      { name: "Document transformation steps", isDone: false, taskId: 38, deadline: new Date("2025-11-11") },

      // --- Task 39 ---
      { name: "Verify dataset against requirements", isDone: true, taskId: 39, deadline: new Date("2025-10-20") },
      { name: "Run automated QA scripts", isDone: true, taskId: 39, deadline: new Date("2025-10-21") },
      { name: "Check random samples manually", isDone: false, taskId: 39, deadline: new Date("2025-10-22") },
      { name: "Test transformation accuracy", isDone: true, taskId: 39, deadline: new Date("2025-10-23") },
      { name: "Verify edge cases in data", isDone: true, taskId: 39, deadline: new Date("2025-10-24") },
      { name: "Log and report QA findings", isDone: false, taskId: 39, deadline: new Date("2025-10-25") },
      { name: "Prepare QA summary report", isDone: false, taskId: 39, deadline: new Date("2025-10-26") },

      // --- Task 40 ---
      { name: "Create summary tables", isDone: true, taskId: 40, deadline: new Date("2025-10-27") },
      { name: "Visualize trends with charts", isDone: true, taskId: 40, deadline: new Date("2025-10-28") },
      { name: "Highlight key improvements", isDone: true, taskId: 40, deadline: new Date("2025-10-29") },
      { name: "Prepare executive summary", isDone: true, taskId: 40, deadline: new Date("2025-10-30") },
      { name: "Export dataset statistics", isDone: false, taskId: 40, deadline: new Date("2025-10-31") },
      { name: "Add recommendations section", isDone: true, taskId: 40, deadline: new Date("2025-11-01") },
      { name: "Finalize reporting template", isDone: false, taskId: 40, deadline: new Date("2025-11-02") },
      { name: "Deliver final report", isDone: true, taskId: 40, deadline: new Date("2025-11-03") },

      // --- Task 41 ---
      { name: "Sketch main screens", isDone: true, taskId: 41, deadline: new Date("2025-11-04") },
      { name: "Define user flows", isDone: true, taskId: 41, deadline: new Date("2025-11-05") },
      { name: "Create low-fidelity wireframes", isDone: true, taskId: 41, deadline: new Date("2025-11-06") },
      { name: "Review wireframes with team", isDone: false, taskId: 41, deadline: new Date("2025-11-07") },
      { name: "Update based on feedback", isDone: true, taskId: 41, deadline: new Date("2025-11-08") },
      { name: "Finalize wireframes", isDone: true, taskId: 41, deadline: new Date("2025-11-09") },
      { name: "Prepare handoff for UI design", isDone: true, taskId: 41, deadline: new Date("2025-11-10") },
      { name: "Document wireframe decisions", isDone: false, taskId: 41, deadline: new Date("2025-11-11") },
      { name: "Export wireframes for reference", isDone: true, taskId: 41, deadline: new Date("2025-11-12") },
      { name: "Check wireframe consistency", isDone: false, taskId: 41, deadline: new Date("2025-11-13") },

      // --- Task 42 ---
      { name: "Design home screen", isDone: true, taskId: 42, deadline: new Date("2025-11-14") },
      { name: "Design onboarding screens", isDone: true, taskId: 42, deadline: new Date("2025-11-15") },
      { name: "Create UI components library", isDone: true, taskId: 42, deadline: new Date("2025-11-16") },
      { name: "Design profile screens", isDone: false, taskId: 42, deadline: new Date("2025-11-17") },
      { name: "Design settings screens", isDone: true, taskId: 42, deadline: new Date("2025-11-18") },
      { name: "Design notifications UI", isDone: false, taskId: 42, deadline: new Date("2025-11-19") },
      { name: "Create design assets", isDone: false, taskId: 42, deadline: new Date("2025-11-20") },
      { name: "Review design with team", isDone: true, taskId: 42, deadline: new Date("2025-11-21") },
      { name: "Prepare handoff to frontend", isDone: true, taskId: 42, deadline: new Date("2025-11-22") },

      // --- Task 43 ---
      { name: "Connect authentication endpoints", isDone: true, taskId: 43, deadline: new Date("2025-11-23") },
      { name: "Integrate user data API", isDone: false, taskId: 43, deadline: new Date("2025-11-24") },
      { name: "Connect content endpoints", isDone: true, taskId: 43, deadline: new Date("2025-11-25") },
      { name: "Test API responses", isDone: false, taskId: 43, deadline: new Date("2025-11-26") },
      { name: "Handle error responses", isDone: true, taskId: 43, deadline: new Date("2025-11-27") },
      { name: "Document API integration", isDone: true, taskId: 43, deadline: new Date("2025-11-28") },
      { name: "Set up automated API tests", isDone: false, taskId: 43, deadline: new Date("2025-11-29") },
      { name: "Optimize API calls", isDone: false, taskId: 43, deadline: new Date("2025-11-30") },
      { name: "Secure API endpoints", isDone: true, taskId: 43, deadline: new Date("2025-12-01") },
      { name: "Verify API data mapping", isDone: false, taskId: 43, deadline: new Date("2025-12-02") },
      { name: "Finalize API integration", isDone: false, taskId: 43, deadline: new Date("2025-12-03") },

      // --- Task 44 ---
      { name: "Implement background sync", isDone: false, taskId: 44, deadline: new Date("2025-12-04") },
      { name: "Sync user data", isDone: true, taskId: 44, deadline: new Date("2025-12-05") },
      { name: "Sync content updates", isDone: true, taskId: 44, deadline: new Date("2025-12-06") },
      { name: "Test sync performance", isDone: false, taskId: 44, deadline: new Date("2025-12-07") },
      { name: "Integrate analytics tracking", isDone: true, taskId: 44, deadline: new Date("2025-12-08") },
      { name: "Validate data sync accuracy", isDone: true, taskId: 44, deadline: new Date("2025-12-09") },
      { name: "Debug sync issues", isDone: false, taskId: 44, deadline: new Date("2025-12-10") },
      { name: "Optimize sync logic", isDone: false, taskId: 44, deadline: new Date("2025-12-11") },

      // --- Task 45 ---
      { name: "Test app on iOS devices", isDone: true, taskId: 45, deadline: new Date("2025-12-12") },
      { name: "Test app on Android devices", isDone: true, taskId: 45, deadline: new Date("2025-12-13") },
      { name: "Check push notifications", isDone: false, taskId: 45, deadline: new Date("2025-12-14") },
      { name: "Test login and auth flows", isDone: true, taskId: 45, deadline: new Date("2025-12-15") },
      { name: "Test data sync accuracy", isDone: true, taskId: 45, deadline: new Date("2025-12-16") },
      { name: "Report bugs found", isDone: false, taskId: 45, deadline: new Date("2025-12-17") },
      { name: "Verify bug fixes", isDone: true, taskId: 45, deadline: new Date("2025-12-18") },
      { name: "Retest critical flows", isDone: false, taskId: 45, deadline: new Date("2025-12-19") },
      { name: "Finalize QA report", isDone: true, taskId: 45, deadline: new Date("2025-12-20") },

      // --- Task 46 ---
      { name: "Check website meta tags", isDone: true, taskId: 46, deadline: new Date("2025-12-21") },
      { name: "Audit backlinks", isDone: true, taskId: 46, deadline: new Date("2025-12-22") },
      { name: "Analyze page speed", isDone: true, taskId: 46, deadline: new Date("2025-12-23") },
      { name: "Review mobile responsiveness", isDone: false, taskId: 46, deadline: new Date("2025-12-24") },
      { name: "Check on-page SEO", isDone: true, taskId: 46, deadline: new Date("2025-12-25") },
      { name: "Identify SEO issues", isDone: true, taskId: 46, deadline: new Date("2025-12-26") },
      { name: "Compile audit report", isDone: true, taskId: 46, deadline: new Date("2025-12-27") },
      { name: "Prioritize SEO fixes", isDone: false, taskId: 46, deadline: new Date("2025-12-28") },
      { name: "Share audit with team", isDone: true, taskId: 46, deadline: new Date("2025-12-29") },
      { name: "Schedule follow-up audit", isDone: false, taskId: 46, deadline: new Date("2025-12-30") },

      // --- Task 47 ---
      { name: "Update homepage content", isDone: true, taskId: 47, deadline: new Date("2025-10-20") },
      { name: "Revise blog articles", isDone: true, taskId: 47, deadline: new Date("2025-10-21") },
      { name: "Optimize product descriptions", isDone: true, taskId: 47, deadline: new Date("2025-10-22") },
      { name: "Add internal links", isDone: false, taskId: 47, deadline: new Date("2025-10-23") },
      { name: "Check content readability", isDone: true, taskId: 47, deadline: new Date("2025-10-24") },
      { name: "Proofread content", isDone: false, taskId: 47, deadline: new Date("2025-10-25") },
      { name: "Update images and media", isDone: false, taskId: 47, deadline: new Date("2025-10-26") },
      { name: "Publish optimized content", isDone: true, taskId: 47, deadline: new Date("2025-10-27") },
      { name: "Verify content updates", isDone: true, taskId: 47, deadline: new Date("2025-10-28") },

      // --- Task 48 ---
      { name: "Identify target keywords", isDone: true, taskId: 48, deadline: new Date("2025-10-20") },
      { name: "Analyze competitor keywords", isDone: false, taskId: 48, deadline: new Date("2025-10-21") },
      { name: "Group keywords by topic", isDone: true, taskId: 48, deadline: new Date("2025-10-22") },
      { name: "Check keyword search volume", isDone: false, taskId: 48, deadline: new Date("2025-10-23") },
      { name: "Assess keyword difficulty", isDone: true, taskId: 48, deadline: new Date("2025-10-24") },
      { name: "Prioritize high-value keywords", isDone: true, taskId: 48, deadline: new Date("2025-10-25") },
      { name: "Compile keyword list", isDone: false, taskId: 48, deadline: new Date("2025-10-26") },
      { name: "Share keyword research", isDone: false, taskId: 48, deadline: new Date("2025-10-27") },
      { name: "Update SEO strategy", isDone: true, taskId: 48, deadline: new Date("2025-10-28") },
      { name: "Finalize keyword report", isDone: false, taskId: 48, deadline: new Date("2025-10-29") },
      { name: "Schedule review session", isDone: false, taskId: 48, deadline: new Date("2025-10-30") },

      // --- Task 49 ---
      { name: "Collect SEO metrics", isDone: false, taskId: 49, deadline: new Date("2025-10-20") },
      { name: "Analyze traffic trends", isDone: true, taskId: 49, deadline: new Date("2025-10-21") },
      { name: "Check keyword rankings", isDone: true, taskId: 49, deadline: new Date("2025-10-22") },
      { name: "Assess backlink profile", isDone: false, taskId: 49, deadline: new Date("2025-10-23") },
      { name: "Identify performance gaps", isDone: true, taskId: 49, deadline: new Date("2025-10-24") },
      { name: "Visualize SEO data", isDone: true, taskId: 49, deadline: new Date("2025-10-25") },
      { name: "Prepare SEO report", isDone: false, taskId: 49, deadline: new Date("2025-10-26") },
      { name: "Review report with team", isDone: false, taskId: 49, deadline: new Date("2025-10-27") },

      // --- Task 50 ---
      { name: "Connect analytics tools", isDone: true, taskId: 50, deadline: new Date("2025-10-20") },
      { name: "Check traffic sources", isDone: true, taskId: 50, deadline: new Date("2025-10-21") },
      { name: "Analyze user behavior", isDone: false, taskId: 50, deadline: new Date("2025-10-22") },
      { name: "Review conversion rates", isDone: true, taskId: 50, deadline: new Date("2025-10-23") },
      { name: "Assess SEO impact", isDone: true, taskId: 50, deadline: new Date("2025-10-24") },
      { name: "Document findings", isDone: false, taskId: 50, deadline: new Date("2025-10-25") },
      { name: "Create recommendations", isDone: true, taskId: 50, deadline: new Date("2025-10-26") },
      { name: "Schedule review meeting", isDone: false, taskId: 50, deadline: new Date("2025-10-27") },
      { name: "Finalize analytics report", isDone: true, taskId: 50, deadline: new Date("2025-10-28") },

      // --- Task 51 ---
      { name: "Define campaign goals", isDone: true, taskId: 51, deadline: new Date("2025-10-20") },
      { name: "Outline target audience", isDone: true, taskId: 51, deadline: new Date("2025-10-21") },
      { name: "Set KPIs", isDone: true, taskId: 51, deadline: new Date("2025-10-22") },
      { name: "Review competitor strategies", isDone: false, taskId: 51, deadline: new Date("2025-10-23") },
      { name: "Plan campaign phases", isDone: true, taskId: 51, deadline: new Date("2025-10-24") },
      { name: "Create budget plan", isDone: true, taskId: 51, deadline: new Date("2025-10-25") },
      { name: "Finalize strategy document", isDone: true, taskId: 51, deadline: new Date("2025-10-26") },
      { name: "Share plan with stakeholders", isDone: false, taskId: 51, deadline: new Date("2025-10-27") },
      { name: "Approve campaign strategy", isDone: true, taskId: 51, deadline: new Date("2025-10-28") },
      { name: "Schedule strategy review", isDone: false, taskId: 51, deadline: new Date("2025-10-29") },

      // --- Task 52 ---
      { name: "Collect demographic data", isDone: true, taskId: 52, deadline: new Date("2025-10-20") },
      { name: "Analyze competitor audience", isDone: true, taskId: 52, deadline: new Date("2025-10-21") },
      { name: "Identify audience pain points", isDone: true, taskId: 52, deadline: new Date("2025-10-22") },
      { name: "Survey target users", isDone: false, taskId: 52, deadline: new Date("2025-10-23") },
      { name: "Segment audience groups", isDone: true, taskId: 52, deadline: new Date("2025-10-24") },
      { name: "Prioritize key segments", isDone: false, taskId: 52, deadline: new Date("2025-10-25") },
      { name: "Validate insights with team", isDone: false, taskId: 52, deadline: new Date("2025-10-26") },
      { name: "Compile audience report", isDone: true, taskId: 52, deadline: new Date("2025-10-27") },
      { name: "Share findings with stakeholders", isDone: true, taskId: 52, deadline: new Date("2025-10-28") },

      // --- Task 53 ---
      { name: "Design banners", isDone: true, taskId: 53, deadline: new Date("2025-10-20") },
      { name: "Create social media graphics", isDone: false, taskId: 53, deadline: new Date("2025-10-21") },
      { name: "Design email templates", isDone: true, taskId: 53, deadline: new Date("2025-10-22") },
      { name: "Create ad visuals", isDone: false, taskId: 53, deadline: new Date("2025-10-23") },
      { name: "Review design consistency", isDone: true, taskId: 53, deadline: new Date("2025-10-24") },
      { name: "Update assets based on feedback", isDone: true, taskId: 53, deadline: new Date("2025-10-25") },
      { name: "Export final visuals", isDone: false, taskId: 53, deadline: new Date("2025-10-26") },
      { name: "Organize assets in repository", isDone: false, taskId: 53, deadline: new Date("2025-10-27") },
      { name: "Share visuals with team", isDone: true, taskId: 53, deadline: new Date("2025-10-28") },
      { name: "Prepare assets for launch", isDone: false, taskId: 53, deadline: new Date("2025-10-29") },
      { name: "Archive old campaign assets", isDone: false, taskId: 53, deadline: new Date("2025-10-30") },

      // --- Task 54 ---
      { name: "Plan content calendar", isDone: false, taskId: 54, deadline: new Date("2025-10-20") },
      { name: "Assign post authors", isDone: true, taskId: 54, deadline: new Date("2025-10-21") },
      { name: "Schedule posts in platform", isDone: true, taskId: 54, deadline: new Date("2025-10-22") },
      { name: "Review scheduled posts", isDone: false, taskId: 54, deadline: new Date("2025-10-23") },
      { name: "Adjust timings for engagement", isDone: true, taskId: 54, deadline: new Date("2025-10-24") },
      { name: "Coordinate with design team", isDone: true, taskId: 54, deadline: new Date("2025-10-25") },
      { name: "Confirm schedule with marketing", isDone: false, taskId: 54, deadline: new Date("2025-10-26") },
      { name: "Update calendar with changes", isDone: false, taskId: 54, deadline: new Date("2025-10-27") },

      // --- Task 55 ---
      { name: "Set up tracking tools", isDone: true, taskId: 55, deadline: new Date("2025-10-20") },
      { name: "Collect engagement metrics", isDone: true, taskId: 55, deadline: new Date("2025-10-21") },
      { name: "Analyze click-through rates", isDone: false, taskId: 55, deadline: new Date("2025-10-22") },
      { name: "Measure conversion rates", isDone: true, taskId: 55, deadline: new Date("2025-10-23") },
      { name: "Identify trends and patterns", isDone: true, taskId: 55, deadline: new Date("2025-10-24") },
      { name: "Document insights", isDone: false, taskId: 55, deadline: new Date("2025-10-25") },
      { name: "Create performance dashboards", isDone: true, taskId: 55, deadline: new Date("2025-10-26") },
      { name: "Share analytics with team", isDone: false, taskId: 55, deadline: new Date("2025-10-27") },
      { name: "Review campaign effectiveness", isDone: true, taskId: 55, deadline: new Date("2025-10-28") },

      // --- Task 56 ---
      { name: "Audit current frontend code", isDone: true, taskId: 56, deadline: new Date("2025-10-20") },
      { name: "Identify performance bottlenecks", isDone: true, taskId: 56, deadline: new Date("2025-10-21") },
      { name: "Refactor heavy components", isDone: true, taskId: 56, deadline: new Date("2025-10-22") },
      { name: "Optimize API calls", isDone: false, taskId: 56, deadline: new Date("2025-10-23") },
      { name: "Improve loading times", isDone: true, taskId: 56, deadline: new Date("2025-10-24") },
      { name: "Test refactored components", isDone: true, taskId: 56, deadline: new Date("2025-10-25") },
      { name: "Update documentation", isDone: true, taskId: 56, deadline: new Date("2025-10-26") },
      { name: "Code review with team", isDone: false, taskId: 56, deadline: new Date("2025-10-27") },
      { name: "Deploy changes to staging", isDone: true, taskId: 56, deadline: new Date("2025-10-28") },
      { name: "Monitor performance metrics", isDone: false, taskId: 56, deadline: new Date("2025-10-29") },

      // --- Task 57 ---
      { name: "Brainstorm new features", isDone: true, taskId: 57, deadline: new Date("2025-10-20") },
      { name: "Prioritize features", isDone: true, taskId: 57, deadline: new Date("2025-10-21") },
      { name: "Draft feature specifications", isDone: true, taskId: 57, deadline: new Date("2025-10-22") },
      { name: "Review feasibility with team", isDone: false, taskId: 57, deadline: new Date("2025-10-23") },
      { name: "Estimate development time", isDone: true, taskId: 57, deadline: new Date("2025-10-24") },
      { name: "Adjust roadmap based on feedback", isDone: false, taskId: 57, deadline: new Date("2025-10-25") },
      { name: "Finalize feature list", isDone: false, taskId: 57, deadline: new Date("2025-10-26") },
      { name: "Present plan to stakeholders", isDone: true, taskId: 57, deadline: new Date("2025-10-27") },
      { name: "Document decisions", isDone: true, taskId: 57, deadline: new Date("2025-10-28") },

      // --- Task 58 ---
      { name: "Identify required endpoints", isDone: true, taskId: 58, deadline: new Date("2025-10-20") },
      { name: "Develop new API endpoints", isDone: false, taskId: 58, deadline: new Date("2025-10-21") },
      { name: "Integrate frontend with API", isDone: true, taskId: 58, deadline: new Date("2025-10-22") },
      { name: "Test API responses", isDone: false, taskId: 58, deadline: new Date("2025-10-23") },
      { name: "Optimize database queries", isDone: true, taskId: 58, deadline: new Date("2025-10-24") },
      { name: "Handle error logging", isDone: true, taskId: 58, deadline: new Date("2025-10-25") },
      { name: "Secure API access", isDone: false, taskId: 58, deadline: new Date("2025-10-26") },
      { name: "Document API changes", isDone: false, taskId: 58, deadline: new Date("2025-10-27") },
      { name: "Deploy API updates", isDone: true, taskId: 58, deadline: new Date("2025-10-28") },
      { name: "Monitor backend performance", isDone: false, taskId: 58, deadline: new Date("2025-10-29") },
      { name: "Review integration with team", isDone: false, taskId: 58, deadline: new Date("2025-10-30") },

      // --- Task 59 ---
      { name: "Create test cases", isDone: false, taskId: 59, deadline: new Date("2025-10-20") },
      { name: "Execute functional tests", isDone: true, taskId: 59, deadline: new Date("2025-10-21") },
      { name: "Report bugs", isDone: true, taskId: 59, deadline: new Date("2025-10-22") },
      { name: "Verify bug fixes", isDone: false, taskId: 59, deadline: new Date("2025-10-23") },
      { name: "Run performance tests", isDone: true, taskId: 59, deadline: new Date("2025-10-24") },
      { name: "Conduct regression testing", isDone: true, taskId: 59, deadline: new Date("2025-10-25") },
      { name: "Document test results", isDone: false, taskId: 59, deadline: new Date("2025-10-26") },
      { name: "Approve release readiness", isDone: false, taskId: 59, deadline: new Date("2025-10-27") },

      // --- Task 60 ---
      { name: "Audit current dashboards", isDone: true, taskId: 60, deadline: new Date("2025-10-20") },
      { name: "Update chart types", isDone: true, taskId: 60, deadline: new Date("2025-10-21") },
      { name: "Optimize data queries", isDone: false, taskId: 60, deadline: new Date("2025-10-22") },
      { name: "Add new metrics", isDone: true, taskId: 60, deadline: new Date("2025-10-23") },
      { name: "Improve chart labels and colors", isDone: true, taskId: 60, deadline: new Date("2025-10-24") },
      { name: "Validate data accuracy", isDone: false, taskId: 60, deadline: new Date("2025-10-25") },
      { name: "Document visualization updates", isDone: true, taskId: 60, deadline: new Date("2025-10-26") },
      { name: "Share updated dashboards with team", isDone: false, taskId: 60, deadline: new Date("2025-10-27") },
      { name: "Collect feedback for next iteration", isDone: true, taskId: 60, deadline: new Date("2025-10-28") },

      // --- Task 61 ---
      { name: "Design database schema", isDone: true, taskId: 61, deadline: new Date("2025-10-20") },
      { name: "Define tables and relationships", isDone: true, taskId: 61, deadline: new Date("2025-10-21") },
      { name: "Set up initial migrations", isDone: true, taskId: 61, deadline: new Date("2025-10-22") },
      { name: "Configure database connections", isDone: false, taskId: 61, deadline: new Date("2025-10-23") },
      { name: "Seed initial data", isDone: true, taskId: 61, deadline: new Date("2025-10-24") },
      { name: "Implement constraints and indexes", isDone: true, taskId: 61, deadline: new Date("2025-10-25") },
      { name: "Test database integrity", isDone: true, taskId: 61, deadline: new Date("2025-10-26") },
      { name: "Optimize queries", isDone: false, taskId: 61, deadline: new Date("2025-10-27") },
      { name: "Document schema design", isDone: true, taskId: 61, deadline: new Date("2025-10-28") },
      { name: "Review setup with team", isDone: false, taskId: 61, deadline: new Date("2025-10-29") },

      // --- Task 62 ---
      { name: "Sketch main inventory screens", isDone: true, taskId: 62, deadline: new Date("2025-10-20") },
      { name: "Create low-fidelity wireframes", isDone: true, taskId: 62, deadline: new Date("2025-10-21") },
      { name: "Review wireframes with stakeholders", isDone: true, taskId: 62, deadline: new Date("2025-10-22") },
      { name: "Adjust layout based on feedback", isDone: false, taskId: 62, deadline: new Date("2025-10-23") },
      { name: "Define navigation flow", isDone: true, taskId: 62, deadline: new Date("2025-10-24") },
      { name: "Create alternative design options", isDone: false, taskId: 62, deadline: new Date("2025-10-25") },
      { name: "Finalize wireframes", isDone: false, taskId: 62, deadline: new Date("2025-10-26") },
      { name: "Prepare wireframes for UI design", isDone: true, taskId: 62, deadline: new Date("2025-10-27") },
      { name: "Document wireframe specifications", isDone: true, taskId: 62, deadline: new Date("2025-10-28") },

      // --- Task 63 ---
      { name: "Define API endpoints", isDone: true, taskId: 63, deadline: new Date("2025-10-20") },
      { name: "Implement CRUD operations", isDone: false, taskId: 63, deadline: new Date("2025-10-21") },
      { name: "Integrate with database", isDone: true, taskId: 63, deadline: new Date("2025-10-22") },
      { name: "Handle validation and errors", isDone: false, taskId: 63, deadline: new Date("2025-10-23") },
      { name: "Implement authentication", isDone: true, taskId: 63, deadline: new Date("2025-10-24") },
      { name: "Add logging and monitoring", isDone: true, taskId: 63, deadline: new Date("2025-10-25") },
      { name: "Optimize API performance", isDone: false, taskId: 63, deadline: new Date("2025-10-26") },
      { name: "Test all endpoints", isDone: false, taskId: 63, deadline: new Date("2025-10-27") },
      { name: "Deploy API to staging", isDone: true, taskId: 63, deadline: new Date("2025-10-28") },
      { name: "Document API usage", isDone: false, taskId: 63, deadline: new Date("2025-10-29") },
      { name: "Code review and approval", isDone: false, taskId: 63, deadline: new Date("2025-10-30") },

      // --- Task 64 ---
      { name: "Integrate analytics library", isDone: false, taskId: 64, deadline: new Date("2025-10-20") },
      { name: "Design dashboard layout", isDone: true, taskId: 64, deadline: new Date("2025-10-21") },
      { name: "Add key metrics", isDone: true, taskId: 64, deadline: new Date("2025-10-22") },
      { name: "Implement filters and drill-downs", isDone: false, taskId: 64, deadline: new Date("2025-10-23") },
      { name: "Connect to backend data", isDone: true, taskId: 64, deadline: new Date("2025-10-24") },
      { name: "Validate data accuracy", isDone: true, taskId: 64, deadline: new Date("2025-10-25") },
      { name: "Optimize dashboard performance", isDone: false, taskId: 64, deadline: new Date("2025-10-26") },
      { name: "Review with team", isDone: false, taskId: 64, deadline: new Date("2025-10-27") },

      // --- Task 65 ---
      { name: "Write test cases for inventory", isDone: true, taskId: 65, deadline: new Date("2025-10-20") },
      { name: "Perform functional testing", isDone: true, taskId: 65, deadline: new Date("2025-10-21") },
      { name: "Report identified bugs", isDone: false, taskId: 65, deadline: new Date("2025-10-22") },
      { name: "Verify bug fixes", isDone: true, taskId: 65, deadline: new Date("2025-10-23") },
      { name: "Test performance under load", isDone: true, taskId: 65, deadline: new Date("2025-10-24") },
      { name: "Conduct regression testing", isDone: false, taskId: 65, deadline: new Date("2025-10-25") },
      { name: "Validate data integrity", isDone: true, taskId: 65, deadline: new Date("2025-10-26") },
      { name: "Document test results", isDone: false, taskId: 65, deadline: new Date("2025-10-27") },
      { name: "Sign off QA approval", isDone: true, taskId: 65, deadline: new Date("2025-10-28") },
    ],
  });
