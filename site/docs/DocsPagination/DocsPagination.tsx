  ...
  const pagination = useMemo(() => {
    ...
    const pagesMap: Record<string, { slug: string; label: string }[]> = {
      ...
      projects: [
        ...
        { slug: "import-export", label: t("projects.importExport") },
      ...
      tasks: [
        ...
        { slug: "import-export", label: t("tasks.importExport") },
      ...
      team: [
        ...
        { slug: "import-export", label: t("team.importExport") },
      ...
      clients: [
        ...
        { slug: "import-export", label: t("clients.importExport") },
