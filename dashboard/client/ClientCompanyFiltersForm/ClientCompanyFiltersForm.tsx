...
interface ClientCompanyFiltersFormProps {
  companyCheckboxGroupItems: { id: number; name: string }[];
}

export function ClientCompanyFiltersForm({
  companyCheckboxGroupItems,
}: ClientCompanyFiltersFormProps) {
  ...
  const { companyIds } = useClientFiltersForm();
  ...
  return (
    <FormBase id="client-company-filters-form" onSubmit={handleSubmit}>
