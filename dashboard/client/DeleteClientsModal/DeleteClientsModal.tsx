...
export function DeleteClientsModal() {
  const t = useTranslations("dashboard.clients.DeleteClientsModal");
  const { isOpen, onOpenChange } = useModal("deleteClients");
  const { ids: selectedIds, clear: clearSelectedItems } = useSelectedItems();
  const { action, setIds: setDeleteClientIds } = useDeleteClients();
  ...
  return (
    <ConfirmModal
      data-test="delete-clients-modal"
      isOpen={isOpen}
    ...
    >
      ...
      <ConfirmModalActions>
        ...
        <ConfirmModalConfirmButton
          ...
          data-test="delete-clients-modal-confirm-button"
        />
      </ConfirmModalActions>
    </ConfirmModal>
  );
